...
public class FrameAgregarProyecto extends javax.swing.JFrame{
    ...
    public FrameAgregarProyecto(ConsolaAplicacion consola, InterfazAdministrador pInterfaz, String pNombrePadre) {
        initComponents();
        ...
        lblAgregarProyecto.setText("AGREGAR PAQUETE");
        lblNombre.setText("Nombre del trabajo");
        
        lblFechaInicio.setVisible(false);
        dateFechaInicial.setVisible(false);
        lblTiposDisponibles.setVisible(false);
        txtTiposDisponibles.setVisible(false);
    ...
    private void initComponents() {
        ...
        checkFechaFinalizacion.setText("Se conoce la fecha de finalización");
        ...
        checkFechaFinalizacion.setVisible(false);
    }
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) 
    {
        ...
        consola.agregarNodo(nombrePadre, "PaqueteTrabajo", Nombre, Descripcion, "");
        interfaz.update();
		JOptionPane.showMessageDialog(null, "Paquete creado el d�a "+ LocalDateTime.now().getDayOfMonth()+" del mes de "+LocalDateTime.now().getMonth(), "Crear proyecto", JOptionPane.INFORMATION_MESSAGE);
		dispose();
    }
